# Justin Welsh｜Raw Corpus Index

这不是全文复制区。

当前状态：初始构建完成，基于 content-goldmine 拆解后的结构化素材。
...
## Layer 2｜表达碎片集（expression fragments）
...
4. 不要只按"编号清单信号"补语料，优先补能证明：
   ...
   - 公式化推进在不同场景的稳定性
   - 与 Dan Koe 的边界区分
5. content-goldmine 拆解稿默认作为语言风格主证据，Clipping 原文作为交叉验证层
