...
description: First-time setup flow for post2wechat preferences
---
...
options:
  - label: "dapeng-editorial (Recommended)"
    description: "Serif editorial - warm paper tone, restrained hierarchy, deep ink-blue headings"
  - label: "default"
  ...
  - label: "apple"
    description: "Minimal tech editorial - spacious, grayscale, refined"
  - label: "byte"
    description: "Sharp product style - modular, crisp, modern"
  - label: "notion"
    description: "Document aesthetic - calm paper feel, markdown-friendly"
  - label: "claude"
    description: "Warm premium editorial - soft contrast, elegant long-form"
```
...
| Choice  | Path                                    | Scope           |
| ------- | --------------------------------------- | --------------- |
| Project | `.baoyu-skills/post2wechat/EXTEND.md`   | Current project |
| User    | `~/.baoyu-skills/post2wechat/EXTEND.md` | All projects    |
...
```md
default_theme: [dapeng-editorial/default/grace/simple/apple/byte/notion/claude]
